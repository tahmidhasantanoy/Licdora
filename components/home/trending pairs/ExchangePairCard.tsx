...
const ExchangePairCard = ({
  ...
  return (
    <div className="flex items-center justify-center bg-gray-800 border-gray-700 w-xs h-24 px-2.5 py-2 gap-[10px] rounded-md hover:bg-gray-750 transition-colors">
