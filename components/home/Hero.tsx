              ...
              >
                <defs>
                  <linearGradient id="grad1" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" style={{ stopColor: "darkred", stopOpacity: 1 }} />
                    <stop offset="100%" style={{ stopColor: "black", stopOpacity: 1 }} />
                  </linearGradient>
                </defs>
                <path d="M0,100 Q250,0 500,100 L500,500 L0,500 Z" fill="url(#grad1)" />
              </svg>
            </div> */}
...
{/* <div className="w-full h-auto">
  ...
  >
    ...
    <path d="M0,25 Q250,0 500,25 L500,125 L0,125 Z" fill="url(#grad1)" />
  </svg>
</div> */}
...
{/* <div className="w-full h-auto">
  ...
  >
    <defs>
      <linearGradient id="grad1" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="darkred" stopOpacity="1" />
        <stop offset="25%" stopColor="darkred" stopOpacity="1" />
