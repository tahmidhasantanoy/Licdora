...
import licodoraLogo from "@/public/images/coin-logo.png"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 md:gap-12 mb-12">
          ...
          <div className="lg:col-span-2 mt-9">
            <div className="flex items-center gap-3">
              <Image src={licodoraLogo} alt="Brand logo" />
              <p className="text-4xl text-[#F3CFC3] font-medium mb-2 leading-24">{footerData.brandName}</p>
              </div>
            ...
            <form
              ...
              className="relative flex flex-col border border-white border-opacity-100 rounded-full bg-gray-900 text-white w-full max-w-xs h-[56px]"
            >
            <button
              type="submit"
            ...
            <input
              ...
              className="bg-gray-900 border border-[#1A1A1A] text-white placeholder:text-gray-500 rounded-full px-4 py-2 w-full h-[56px]"
              required
            />
          </form>
          </div>
          ...
          {footerData.sections.map((section, index) => (
            <div key={index} className="lg:col-span-1 mt-[120px]">
