...
const ClientNav = () => {
    ...
    return (
        <nav className={`${horizontalDistance > 40 ? "bg-[#3b120f]" : "bg-transparent" } flex justify-between  p-5 fixed w-full top-0 z-50 items-center transition-all duration-700`}>
            <Logo />
